...
# Production secrets - MUST be set in Render environment
SECRET_KEY = os.environ.get("DJANGO_SECRET_KEY")
if not SECRET_KEY and not os.environ.get("RENDER"):
    # Only allow insecure key in local development
    SECRET_KEY = "insecure-dev-secret-for-local-only"
...
if os.environ.get("DATABASE_URL"):
    # Production: Use Postgres on Render
    DATABASES = {
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "API for trip management, itinerary, polls, chat.",
    "VERSION": "1.0.0",
}
...
MIDDLEWARE = [
    ...
    "django.contrib.messages.middleware.MessageMiddleware",
    "django.middleware.clickjacking.XFrameOptionsMiddleware",
    # Custom middleware (added later in api.middleware)
    "api.middleware.RequestResponseLoggingMiddleware",
    "api.middleware.RateLimitMiddleware",
    "api.middleware.GlobalExceptionMiddleware",
]
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Smart Trip Planner API",
    "DESCRIPTION": "OpenAPI schema for Smart Trip Planner backend",
    "VERSION": "1.0.0",
